...
int main(int argc, char *argv[]) {
	// Open input file, then get input string.
	// Replace all line breaks but the last one, with spaces.
	// Add "Description: " at the beginning;
	// Count characters until predefined maximum, then go back to the last
	// word and replace space by newline.
	// Repeat last operation until end-of-file.
